...
private JPanel booksContainer;
    ...
    public temp() {
        initComponents();
         ...
         booksContainer = new JPanel(new GridLayout(0, 5, 10, 10)); // 5 books in a row with gaps

        // Fetch books from the database
        List<Books> books; // Assuming fetchBooks is a static method in the Items class

        // Populate book detail panels
        

        // Add books container to the main frame
        add(booksContainer);
         setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Close operation
        setSize(800, 600); // Set frame size (adjust as needed)
        setTitle("Book Display"); // Set frame title
      ...
      private class BookDetailPanel extends JPanel {
        private Books book;
        private JButton detailsButton;

        public BookDetailPanel(Books book) {
            this.book = book;

            // Create labels for cover page, title, price, author name
            JLabel coverPageLabel = new JLabel(new ImageIcon(book.getCoverImg()));
